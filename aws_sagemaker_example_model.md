Error when deploying amazon-sagemaker-keras-text-classification model:
"The server encountered an internal error and was unable to complete your request. Either the server is overloaded or there is an error in the application..."

This can be solved by following the link here (https://github.com/aws-samples/amazon-sagemaker-keras-text-classification/issues/4#issuecomment-479282081)

As the author has noted, it is due to the fact the Keras models are not thread safe as of the version this code uses. The work around is to remove static models and use instance models.
